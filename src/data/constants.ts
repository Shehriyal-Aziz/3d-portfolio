...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Elfo Innovations",
    description: [
      "Built and run a web development & digital marketing agency serving international startup clients across the US, EU, and beyond.",
      "Delivered custom websites, CRM systems, and SEO audits across multiple tech stacks including Laravel, WordPress, and Shopify.",
      "Ran full SEO audits for client sites, identifying critical issues like missing canonicals, broken images, and structured data gaps.",
      "Set up cold outreach and lead generation systems with deliverability infrastructure across multiple domains.",
    ],
    skills: [
      SkillNames.WORDPRESS,
      SkillNames.JS,
  ...
  },
  {
    ...
    company: "Self-employed / Coursework Projects",
    description: [
      "Built websites and internal tools using Laravel, ASP.NET, and WordPress, mixing freelance client work with hands-on learning projects.",
      "Debugged and extended authentication systems, CRUD applications, and admin dashboards.",
      "Migrated and deployed sites across hosting environments, resolving real-world production issues along the way.",
      "Currently deepening MERN stack skills (React, Node.js, Express, MongoDB) to expand into modern JavaScript-based development.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
